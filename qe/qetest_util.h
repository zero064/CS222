...
int createLeftTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Left Table****" << endl;
...
int createLeftTable2() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Left2 Table****" << endl;
...
int createLargeLeftTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Large Left Table****" << endl;
...
int createLargeLeftTable2() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Large Left2 Table****" << endl;
	...
	if (rc == success) {
		cout << "****Large left2 Table Created!****" << endl;
	}
	return rc;
}
...
int createLeftVarCharTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Left VarChar Table****" << endl;
	...
	if (rc == success) {
		cout << "****Left VarChar Table Created!****" << endl;
	}
	return rc;
}
...
int createRightTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Right Table****" << endl;
...
int createRightTable2() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Right2 Table****" << endl;
	...
	if (rc == success) {
		cout << "****Right2 Table Created!****" << endl;
	}
	return rc;
}
...
int createLargeRightTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Large Right Table****" << endl;
...
int createLargeRightTable2() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Large Right2 Table****" << endl;
	...
	if (rc == success) {
		cout << "****Large Right2 Table Created!****" << endl;
	}
	return rc;
}
...
int createRightVarCharTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Right VarChar Table****" << endl;
	...
	if (rc == success) {
		cout << "****Right VarChar Table Created!****" << endl;
	}
	return rc;
}
...
int createGroupTable() {
	// Functions Tested;
	// 1. Create Table
	cout << endl << "****Create Group Table****" << endl;
